...
$serviceName = "SSBExternalActivator.DATA_Broker.AC"
$serviceDisplayName = "Service Broker External Activator (DATA_Broker.AC)"
...
$storedProcedure = "dbo.Receive_Messages_AC_NotificationQueue"

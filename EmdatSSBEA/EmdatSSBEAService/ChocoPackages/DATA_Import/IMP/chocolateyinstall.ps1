...
$serviceName = "SSBExternalActivator.DATA_Import.IMP"
$serviceDisplayName = "Service Broker External Activator (DATA_Import.IMP)"
...
$storedProcedure = "dbo.Receive_Messages_IMP_NotificationQueue"
